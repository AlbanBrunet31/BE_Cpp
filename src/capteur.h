...
const int readTimeMax = 4000;    //Duree max pour la lecture de vitesse (ms) : au-dela, vitesse consideree nulle
const float angleEntrePale = 120.0; //Angle entre les pales de l'helice (deg), 180.0 si helice avec deux pales


class capteur{  //Classe mere
public:
    capteur(){
        pin=0;
        nom="SansNom";
...
public:
    ...
    void readRotary() {     //Met a jour la valeur de l'angle
        // gestion position
...
public:
    ...
    *@brief Calcule la vitesse grace au temps ecoule entre deux fronts montants
    ...
    */
    ...
    /*
        *@brief Temps de mesure passe en argument
        *@return float : Vitesse mediane mesuree (rpm)
    */
